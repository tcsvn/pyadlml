...
# Delete operation:
idx_to_del = get_index_matching_rows(df_acts, 	[['09.12.2011 17:59:25.000000','09.12.2011 17:59:27.000000','Grooming']],
)
df_acts = df_acts.drop(index=idx_to_del).reset_index(drop=True)
...
idx_to_del = get_index_matching_rows(df_acts, 	[['03.12.2011 13:29:00.000000','03.12.2011 13:29:48.000000','Grooming']],
)
df_acts = df_acts.drop(index=idx_to_del).reset_index(drop=True)

new_row=pd.Series({START_TIME: pd.Timestamp('2011-12-03 13:29:00'), END_TIME: pd.Timestamp('2011-12-03 13:29:40.048493'), ACTIVITY: 'Grooming'})
df_acts = pd.concat([df_acts, new_row.to_frame().T], axis=0).reset_index(drop=True)
...
idx_to_del = get_index_matching_rows(df_acts, 	[['03.12.2011 13:30:00.000000','03.12.2011 14:01:20.000000','Spare_Time/TV']],
)
df_acts = df_acts.drop(index=idx_to_del).reset_index(drop=True)

new_row=pd.Series({START_TIME: pd.Timestamp('2011-12-03 13:29:46.800408500'), END_TIME: pd.Timestamp('2011-12-03 14:01:20'), ACTIVITY: 'Spare_Time/TV'})
df_acts = pd.concat([df_acts, new_row.to_frame().T], axis=0).reset_index(drop=True)
...
# Delete operation:
idx_to_del = get_index_matching_rows(df_acts, 	[['03.12.2011 17:50:14.000000','03.12.2011 23:53:24.000000','Spare_Time/TV']],
)
df_acts = df_acts.drop(index=idx_to_del).reset_index(drop=True)

new_row=pd.Series({START_TIME: pd.Timestamp('2011-12-03 17:50:14'), END_TIME: pd.Timestamp('2011-12-03 20:37:42.041000'), ACTIVITY: 'Spare_Time/TV'})
df_acts = pd.concat([df_acts, new_row.to_frame().T], axis=0).reset_index(drop=True)

new_row=pd.Series({START_TIME: pd.Timestamp('2011-12-03 20:38:14.333400'), END_TIME: pd.Timestamp('2011-12-03 23:53:24'), ACTIVITY: 'Spare_Time/TV'})
df_acts = pd.concat([df_acts, new_row.to_frame().T], axis=0).reset_index(drop=True)
...
idx_to_del = get_index_matching_rows(df_acts, 	[['29.11.2011 17:08:58.000000','29.11.2011 17:09:29.000000','Toileting']],
)
df_acts = df_acts.drop(index=idx_to_del).reset_index(drop=True)

new_row=pd.Series({START_TIME: pd.Timestamp('2011-11-29 17:08:58'), END_TIME: pd.Timestamp('2011-11-29 17:09:07.788836200'), ACTIVITY: 'Toileting'})
df_acts = pd.concat([df_acts, new_row.to_frame().T], axis=0).reset_index(drop=True)
...
idx_to_del = get_index_matching_rows(df_acts, 	[['01.12.2011 19:27:52.079036','01.12.2011 19:29:59.000000','Toileting']],
)
df_acts = df_acts.drop(index=idx_to_del).reset_index(drop=True)

new_row=pd.Series({START_TIME: pd.Timestamp('2011-12-01 19:27:52.079036800'), END_TIME: pd.Timestamp('2011-12-01 19:29:05.617340'), ACTIVITY: 'Toileting'})
df_acts = pd.concat([df_acts, new_row.to_frame().T], axis=0).reset_index(drop=True)
...
idx_to_del = get_index_matching_rows(df_acts, 	[['28.11.2011 10:21:24.000000','28.11.2011 10:23:36.000000','Toileting']],
)
df_acts = df_acts.drop(index=idx_to_del).reset_index(drop=True)

new_row=pd.Series({START_TIME: pd.Timestamp('2011-11-28 10:21:53.914268'), END_TIME: pd.Timestamp('2011-11-28 10:23:36'), ACTIVITY: 'Toileting'})
df_acts = pd.concat([df_acts, new_row.to_frame().T], axis=0).reset_index(drop=True)
